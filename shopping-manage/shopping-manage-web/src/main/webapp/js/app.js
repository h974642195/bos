...
var App = function () {
    ...
    return {
        ...
        init: function () {
		    ...
		    // Set iframe height the same as this screenHeight 
            //core handlers
            handleInit();
	...
	/**		
	 *  this iframe click to change the html
	 */
	var changeiframe = {
		chooseSrc:function(){
			$(".page-sidebar-menu [alt]").click(function(){
				$('#ihtml')[0].src=this.getAttribute('alt');
			})
		},
	}
	changeiframe.chooseSrc()